...
client.on('guildMemberAdd', member => {
  let channel = member.guild.channels.find('name', '❤》lounge');
  ...
  let embed = new Discord.RichEmbed()
      ...
      .addField('🔥|Welcome » ' , `Welcome to :rose: Ｂｌａｃｋ Ｂａｔｕｍｉ :rose: ${member} enjoy your stay and dont forget to asign your roles in #❤》self-role`)
...
client.on('guildMemberRemove', member =>{
    ...
    member.guild.channels.get('526168579297640450').send(embed)
